...
?>
        ...
        <p>
            <form action="process_update_reply.php?reply_no=<?=$_GET['reply_no']?>&board_no=<?=$_GET['board_no']?>" method="POST">
                <p>댓글 내용: <input type="text" name="reply_content" value=<?=$row['content']?> required></p>
